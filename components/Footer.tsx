    ...
    <footer className="bg-surface-0">
      <div className="container mx-auto py-26">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-extrabold font-heading text-text-primary mb-4 text-balance">
              Product
            </h4>
            <ul className="space-y-2 font-light">
              <li>
                <a
                  href="#features"
                  className="text-text-muted hover:text-accent-primary rounded-md focus:outline-none focus-visible:shadow-focus-glow py-3 block"
                >
                  Features
                </a>
              </li>
