...
import { SunIcon, MoonIcon, EclipseIcon, SparklesIcon, ContrastIcon, CosmicDawnIcon } from './icons/ThemeIcons';
...
const themeConfig: Record<Theme, { icon: React.ReactNode; label: string }> = {
    ...
    'cosmic-dawn': { icon: <CosmicDawnIcon className="w-5 h-5" />, label: 'Cosmic Dawn' },
