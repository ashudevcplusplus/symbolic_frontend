...
export const HeroIllustration: React.FC<{ isIgnited: boolean }> = ({
  isIgnited,
}) => (
  <svg
    width="100%"
  ...
  >
    ...
    <g
      ...
      className={`transition-all duration-700 ease-orbital ${isIgnited ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}
    >
      <g transform="rotate(-8)">
        {/* Main Arc */}
        <path
          d="M -150 -150 A 212 212 0 0 1 150 -150"
        ...
        <path
          ...
          strokeWidth="2"
          strokeDasharray="4 8"
          className="motion-safe:animate-[dash-flow_30s_linear_infinite]"
        />

        {/* Inner Arc */}
        <path
          d="M -120 -120 A 170 170 0 0 1 120 -120"
          stroke="hsl(var(--surface-3))"
          strokeWidth="0.5"
          strokeDasharray="2 2"
        />
        ...
        <circle
          ...
          filter="url(#glow)"
          className="motion-safe:animate-[gentle-pulse_3s_ease-in-out_infinite]"
